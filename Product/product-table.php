    ...
    <div class="sidebar">
      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-header">Tables</li>
            ...
            <a href="http://localhost/Food_Ordering_Project/Banner-ad/banner-table.php" class="nav-link">
              ...
              <p>Banner Ad</p>
                              ...
                              <li class="nav-item">
            <a href="http://localhost/Food_Ordering_Project/Users/user-form.php" class="nav-link">
              <i class="fas fa-circle nav-icon"></i>
              <p>User</p>
            </a>
          </li>
          ...
          <li class="nav-item">
            <a href="http://localhost/Food_Ordering_Project/Menu/menu-table.php" class="nav-link">
            ...
            <li class="nav-item">
              <a href="http://localhost/Food_Ordering_Project/Product/product-table.php" class="nav-link">
                <i class="nav-icon fas fa-circle"></i>
                <p>
                 Product
                </p>
...
<div class="table-data">
 ...
 <h2>Product List </h2> 
             ...
             <button >  <a href="http://localhost/Food_Ordering_Project/Product/create-form.php">Add Product</a></button>
            <br><br>
    <table border="1">
        <tr>
            <th>S.N</th>
...
<td><?php echo $data['short_details'];?> </td>
<td><?php echo $data['price']; ?></td>
<td><?php echo $data['image_url']; ?></td>
<td><?php echo $data['tag_name'];?> </td>
